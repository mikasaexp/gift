...
/* ---------- tap-to-enlarge lightbox for gallery photos ---------- */
(function lightbox(){
...
/* ---------- hand-drawn doodles: the line "draws itself" when scrolled into view ---------- */
(function doodleDraw(){
  const paths = document.querySelectorAll('.doodle-line');
  paths.forEach(p => {
  ...
  paths.forEach(p => doodleObserver.observe(p));
})();
